...
const AnimatedNumber_001 = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center bg-[#f5f4f3] text-black">
      ...
      <div className="text-[20vw] tracking-tight font-extrabold font-mono">
      ...
      <div className="flex w-fit items-center gap-2">
        ...
        >
          <svg className="rotate-45 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center bg-[#f5f4f3] text-black">
      ...
      <motion.div
        ...
        className="text-[20vw] tracking-tight font-extrabold font-mono"
      >
        {displaySubs}
      </motion.div>
    </div>
...
const AnimatedNumber_004 = () => {
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center bg-[#f5f4f3] text-black">
      ...
      <div ref={ref} className="text-[20vw] tracking-tight font-extrabold font-mono">
...
// Reusable single-purpose animator for stats inside the portfolio
const PortfolioStatAnimator = ({ value, prefix = "", suffix = "" }) => {
  ...
  return (
    <span ref={ref} className="inline-block font-sans font-black tracking-tight text-lime text-3xl">
